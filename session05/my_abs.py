...
def quadratic(a, b, c):
    ...
    distance_formula = b * b - 4 * a * c
    sqrt_part = math.sqrt(abs(distance_formula))
    if distance_formula > 0:  
        print((-b + sqrt_part) / (2 * a))  
        print((-b - sqrt_part) / (2 * a))  
    elif distance_formula == 0:
        print(-b / (2 * a))  
    else:
        print('Sorry, didin\'t learn this in highschool')
